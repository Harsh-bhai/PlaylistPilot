...
export default function Home() {
  return (
    <div className='min-h-screen bg-gray-800 flex flex-col py-40 items-center space-y-4'>
      ...
      <Link href={'/import'}><button className=" text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-full text-lg translate-y-10 ">LETS GO!</button> </Link>    
    </div>
  )
}
